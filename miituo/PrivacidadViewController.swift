...
class PrivacidadViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let pageHtml = "<!DOCTYPE html>\n" +
            ...
            "@font-face {\n" +
            "font-family: 'feast';\n" +
            "src: local('herne1.ttf'), format('truetype');\n" +
            "}\n" +
            ...
            "            <br><br>\n" +
            "            El uso de este sito online constituye la total aceptaci&oacute;n de los t&eacute;rminos y condiciones contenidos en el Aviso de\n" +
    ...
    */
    @IBAction func cerrarprivacidad(_ sender: Any) {
